...
- 游戏：Crack Tap
- 类型：casual
- 简述：A risk-and-reward fortune orb. Hold as cracks spider across it — the deeper you dare (Whisper → Vision → Revelation → Brink), the rarer the omen. Release to lock it; push too far and it shatters.
- 框架 / 语言 / 构建：TypeScript, Vite
- 渲染方式：Canvas/WebGL
- 依赖摘录：vite@^5.1.0
- 平台元信息：meta.title=Crack Tap；cover_url=/poster.png；category=casual；uuid=10b8a17b-313c-4f2e-a78e-6d68c6037253
